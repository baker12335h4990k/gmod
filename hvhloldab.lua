...
local chatspam2 = {  	   
	"hail hitler!",  	   
	"??????",  	   
	"what do you call a black person playing gmod? a nigger!",  	   
	"get dunked kiddos.",  	   
	"wots a hack dud?!?!",  	   
	"do u guys use lennys or something?!?! wtf.",  	   
	"fuk al yew white honkey niggers",  	   
	"cdriza owns you dude",  	   
}  	   
...
local function GetPos(v)  	   
	if (gBool("Aimbot", "p100mode")) then return( em.LocalToWorld(v, em.OBBCenter(v)) ); end  	   
...
function GAMEMODE:entity_killed(event)  	   
	if (!gBool("Misc.", "Quakesounds")) then quake = 0; return; end  	   
